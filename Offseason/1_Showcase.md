...
- Sent people out to groups wrong.
- Little rushed and over excited.
...
3. Wiring (3rd and 4th table).
4. Simulation/software (Classroom).
...
- Assemble something super small, keychain could be the part they just.
...
- Ask everyone their name and grade, what they would like to do on the team, introduced self.
- Showed off 2024 robot on one table.
- Talk about how each year the robot is given the challenge to pick up/ shoot/interact with a gamepiece, have the gamepiece in front of the robot.
- Talked about how the robot gets points for doing certain things .
...
- 2026 offbot Drivetrain set up on table, plug motors into a wago.
- Motors set up on table.
- Scrap wires .
- Wire strippers, crimpers, wagos.
Agenda
...
- 2 Laptops, 2 controllers.
- Have real robot set up on table show drivebase view in andvantage scope .
- Have 2025 robot sim pulled up.
- Have 2024 robot sim pulled up.
- Have 2023 Robot sim pulled up.
- Have sim set up to play FRC game.
- Mo Sim 2026.
Agenda
...
- Ping pong bot set up outside with driver station .
- Demo 2026 bot.
Agenda

- Get eveyone’s names, grade, what they want to do on the team.
- Ping Pong bot demo, showed what it can do .
- Teach them controls.
- Have them drive.
- Aim towards the tote, (They need a target).
- *New idea put limelight and have it track retro reflective, have a kids wear the vest and shoot them with balls.
...
- Frisbee outside on table.
- Robust setup, wood base clamped on table, electrical panel clamped.
Agenda

- Get eveyone’s names, grade, what they want to do on the team.
- 1 Demo by self going over the sequence.
- Have the get in line.
- Run them through how the whole system works.
- Teach dials, breaker, electrical system, how to connect other motors .
- Explain it deeper when they were putting frisbees in.
Media

- Show viral frisbee, have guess views.
- Show 40 million note throw.
...
- People get numbered off as individuals.
- Clearer communication about structure and rotation.
- Be mindful to taking photos.
