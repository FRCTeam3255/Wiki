...
- Clean your area (tools and supplies), leave sheet metal (cut parts) on table
...
| 3:15 pm  |   2 hr   | [Scoring method Analysis](Topic%202.1%20-%20Scoring%20Analysis.md) <br>(**ranking points vs match points**)<br>(point calculations/combinations, look at density, looking at auto vs teleop)<br>(Do RP become match points?)<br>Consider our robot the only robot<br>one person read one person write<br>include processing time in durations/max scores |
| 5:15 pm  |  30 min  | **Dinner**                                                                                                                                                                                                             |
| 5:45 pm  |   2 hr   | [Feature importance List creation](Topic%202.2%20-%20Feature%20Importance%20List.md) <br>(features are ability that our robot has that drive the design) <br>(ex. score high, mid, low, all autonomous)                                                                    |
